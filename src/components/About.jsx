...
import user_image from '../assets/image.jpg'
  ...
  return (
    ...
    <div className="flex w-full flex-col lg:flex-row items-center gap-20 my-20">
        ...
        <div className="flex-1">
            <p className="mb-10 max-w-2xl font-Ovo">A passionate Web Developer Enthusiastic. Hi, I'm Vivek, A computer science student at ABES Engineering College. I work with MERN Stack, C++, Data Structures, and Competitive Programming, passionate about problem-solving and exploring new technologies. Eager to contribute to innovative projects and collaborate with industry professionals.</p>
